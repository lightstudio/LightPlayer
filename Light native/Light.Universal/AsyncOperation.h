...
namespace ABI {
	namespace Windows {
		namespace Foundation {
            template<> struct __declspec(uuid("547A3413-96DA-42FE-B83A-FA9E6AE3DF36")) IAsyncOperation <ABI::Windows::Storage::IStorageFolder*> : IAsyncOperation_impl <ABI::Windows::Storage::IStorageFolder*> { static const wchar_t* z_get_rc_name_impl() { return L""; } };
            template<> struct __declspec(uuid("40E2F856-0627-49FA-8F58-6C324DA3619C")) IAsyncOperationCompletedHandler<ABI::Windows::Storage::IStorageFolder*> : IAsyncOperationCompletedHandler_impl<ABI::Windows::Storage::IStorageFolder*> { static const wchar_t* z_get_rc_name_impl() { return L""; } };
			template<> struct __declspec(uuid("A411C218-4A2A-4A20-83F2-78BB064C08B6")) IAsyncOperation <ABI::Windows::Storage::IStorageFile*> : IAsyncOperation_impl <ABI::Windows::Storage::IStorageFile*> { static const wchar_t* z_get_rc_name_impl() { return L""; } };
			template<> struct __declspec(uuid("F133C35D-328E-46B8-A165-0658CD71DD36")) IAsyncOperationCompletedHandler<ABI::Windows::Storage::IStorageFile*> : IAsyncOperationCompletedHandler_impl<ABI::Windows::Storage::IStorageFile*> { static const wchar_t* z_get_rc_name_impl() { return L""; } };
		}
	}
}
...
protected:
	...
	void RunAsContinuation(Microsoft::WRL::ComPtr<TPrevious> const& previousOperation, TFunction&& workerFunction)
	{
		...
		auto continuation = Callback<CallbackType>([=](TPrevious*, AsyncStatus status)
		{
			...
			// Not checking previous operation status.
			// previous.GetResult() will return null if
			// previous operation failed. So pass it 
