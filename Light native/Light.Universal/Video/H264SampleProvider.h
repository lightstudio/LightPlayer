...
namespace Light {
	namespace Video {
		...
		private:
			HRESULT WriteNALPacket(Windows::Storage::Streams::DataWriter^ dataWriter, AVPacket* avPacket);
			HRESULT GetSPSAndPPSBuffer(Windows::Storage::Streams::DataWriter^ dataWriter);
		internal:
			H264SampleProvider(
				FFmpegReader^ reader,
