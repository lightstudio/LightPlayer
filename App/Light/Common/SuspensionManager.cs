...
namespace Light.Common
{
    ...
    internal sealed class SuspensionManager
    {
        ...
        /// <summary>
        /// Save the current <see cref="SessionState"/>.  Any <see cref="RegisterFrame"/> instances
        /// registered with <see cref="Page"/> will also preserve their current
        /// navigation stack, which in turn gives their active <see cref="Frame"/> an opportunity
        /// to save its state.
        /// </summary>
